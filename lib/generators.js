...
/**
 * Generate a sample index file at projectBasePath/ProjectName/index.js
 * @param {string} mongoURI
...
/**
 * Generate a Mongoose model file at projectBasePath/ProjectName/Models/SchemaName.js
...
function generateModel(projectBasePath, projectName, schemaName, schemaFields) {
    ...
    fileTools.createDirIfIsNotDefined(path.join(projectBasePath, projectName), 'models');
    fileTools.writeFile(pathToWrite, modelFileText);
}

/**
 * Generate a package.json file at projectBasePath/ProjectName/package.json
 * Generate a README.md file at projectBasePath/ProjectName/README.md
