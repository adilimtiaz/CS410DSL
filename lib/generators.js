...
function insertIntoSchema(projectBasePath, projectName, schemaName, schemaFields, mongoURI){
    let formattedFields = formatFieldsToInsert(schemaFields);
    return mongoHandler.insertIntoSchema(projectBasePath, projectName, schemaName, formattedFields, mongoURI);
}
...
function formatFieldsToInsert(fields) {
    let formattedFields = {};
