...
// const generateIndexFile = (projectBasePath, projectName, routeNames, mongoURI ) => {
//     if (!projectBasePath | !mongoURI | !projectName | !routeNames) throw new Error(`Missing ${!projectBasePath | !mongoURI | !projectName | !routeNames} in generateIndexFile`);
//     let indexFileText = expressTemplate(mongoURI, routeNames);
//     let pathToWrite = path.join(projectBasePath, `./${projectName}/index.js`);
//     createDirIfIsNotDefined(projectBasePath, projectName);
