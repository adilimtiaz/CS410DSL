...
module.exports = {
    ...
    lex: function(inputText) {
        ...
        if (lexingResult.errors.length > 0) {
            ...
            throw Error(lexingResult.errors.map(error => error.message) + " Check line " + lexingResult.errors.map(error => error.line) + ", column " + lexingResult.errors.map(error => error.line) + ".");
        }
